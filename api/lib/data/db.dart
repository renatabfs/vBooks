...
class DBHelper {
  ...
  Future<FutureOr<void>> onCreate(Database db, int version) async {
    ...
    await db.insert('LIVROS', {
      ...
      //a palavra colisoes deveriam estar entre aspas na sinopse
    ...
    await db.insert('LIVROS', {
      ...
      //os elementos semanticos (footer, header, etc) deveriam estar entre aspas cada um
      'autor': 'Mark Pilgrim',
    ...
    await db.insert('LIVROS', {
      ...
      //palavras dinamicamente e dores deveriam estar entre aspas na sinopse
